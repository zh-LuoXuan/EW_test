...
#define	EPWM_CH_6_MSK			(0x40UL)
#define	EPWM_CH_7_MSK			(0x80UL)
...
#define		EPWM_MASK_LOAD_EPWM6	(0x6UL<<EPWM_POEN_MASKLS_Pos)		/*在EPWM6 的加载点加载掩码数据*/
#define		EPWM_MASK_LOAD_EPWM7	(0x7UL<<EPWM_POEN_MASKLS_Pos)		/*在EPWM7 的加载点加载掩码数据*/
/*----------------------------------------------------------------------------
 **EPWM 掩码数据预缓存
-----------------------------------------------------------------------------*/
...
#define		EPWM_DTCTL_DIRRIGHT			(0x00UL)	
#define		EPWM_DTCTL_DIRLEFT			(0x01UL)	
/*----------------------------------------------------------------------------
 **EPWM 计数比较触发ADC采样
-----------------------------------------------------------------------------*/
...
#define		EPWM_CMPTG_EPWM6		(0x06UL)		/*比较器选择EPWM6的计数器*/
#define		EPWM_CMPTG_EPWM7		(0x07UL)		/*比较器选择EPWM7的计数器*/
/*----------------------------------------------------------------------------
 **EPWM 故障保护（刹车）模式
-----------------------------------------------------------------------------*/
...
#define		EPWM_BRK_LOAD_EPWM6		(0x6UL<<EPWM_BRKCTL_BRKRCS_Pos)		/*在EPWM6 的加载点*/
#define		EPWM_BRK_LOAD_EPWM7		(0x7UL<<EPWM_BRKCTL_BRKRCS_Pos)		/*在EPWM7 的加载点*/
